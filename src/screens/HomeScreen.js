...
//                   selectedItem.type === "restaurant" ? parseInt(guestCount, 10) || 1 : 1;
//                 const totalCost = cost * effectiveQuantity;
//                 selectedItemsToAdd.push({ ...selectedItem, cost });
//                 remaining -= totalCost;
//               }
//             }
...
//       setRemainingBudget(0);
//     } catch (error) {
//       console.error('Ошибка при создания свадьбы:', error);
//       alert('Ошибка: ' + (error.response?.data?.error || error.message));
//     }
//   };
...
// Бюджет: {budget ? parseFloat(budget).toLocaleString() : 0} ₸
// </Text>
// <Text style={styles.summaryText}>
...
// <Text style={styles.submitButtonText}>Создать свадьбу</Text>
// </LinearGradient>
// </TouchableOpacity>
// </ScrollView>
// </Animatable.View>
...
// },
// categoryGrid: {
// flexDirection: 'column', // Changed to column for single-column layout
// },
// categoryItem: {
